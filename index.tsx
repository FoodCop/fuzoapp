...
import type { TrimVideo, YouTubeSearchItem } from './src/features/trims/types/trimsUi';
        ...
        {currentStep === 3 && (
          <div className="h-full flex flex-col items-center justify-center p-8 bg-emerald-500 animate-in fade-in duration-700 text-center space-y-8">
            ...
            <div className="max-w-md w-full space-y-4 pt-12">
              <button
                onClick={() => !isPostingToFeed && !feedPostSuccess && handleFinish(true)}
                disabled={isPostingToFeed || feedPostSuccess}
                className={`w-full py-7 rounded-[3rem] font-black uppercase tracking-widest text-sm shadow-2xl flex items-center justify-center gap-4 border-4 transition-all ${
                  feedPostSuccess 
                    ? 'bg-emerald-500 text-white border-emerald-400' 
