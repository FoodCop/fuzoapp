...
export const NavIcon = ({ icon: Icon, active, onClick, label }: NavIconProps) => (
  <button
    ...
    className={`flex flex-col items-center gap-1 transition-all duration-300 min-w-[44px] min-h-[44px] ${active ? 'text-stone-900' : 'text-stone-300 hover:text-stone-500'}`}
  >
